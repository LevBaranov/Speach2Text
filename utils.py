...
TEXT_ABOUT = """
Я конвертирую голосовые и видео сообщения в текстовый формат.
Ты можешь добавлять меня в чаты или отправлять мне сообщения, которые необходимо трансформировать в текст. После добавления в групповой чат, не забудь выдать мне доступ к сообщениям. Для этого добавь меня в админы, можешь забрать все лишние права, главное чтобы был доступ к сообщениям.
C помощью команды /settings, ты можешь настроить, что переводить Аудио, Видео или и то и другое. 

Если хочешь поддержать сервис 💰💰, можешь отправить на согревающий кофе моему автору - http://qiwi.com/n/SPEECH2TEXT.
